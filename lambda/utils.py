...
def getCityNameWithIdFromApiRequestSlots(handler_input):
    ...
    if(
        ...
        resolvedCityName.resolutions.resolutionsPerAuthority and
        resolvedCityName.resolutions.resolutionsPerAuthority[0] and
        resolvedCityName.resolutions.resolutionsPerAuthority[0].status and
